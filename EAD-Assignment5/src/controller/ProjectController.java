 ...
 * 
 * @author Harshit 
 * Shopping Cart ProjectController 
 */
public class ProjectController
{
    ...
    {
        outputView.displayListOfProducts(getNameOfProduct(),
                getPriceOfProduct());
    }
    
    /**
     * 
     * Add Products in the bucket varify quantity and product id is correct or
     * not
     * 
    ...
    public String addProductInBucket()
    {
        ...
        {
            return "Sorry Now we have only " + getSizeOfProductList()
                    + " Products";
        }
        else if (!(productID > indexOfFirstProducts))
        {
            return "Sorry Product Sequence Starts From 1";
        }
        else
        {
    ...
    /**
     * Remove product from the bucket check remove details are correct or not
     * 
    ...
    public String placeTheOrder()
    {
        ...
        {
            displayBucketProducts();
            outputView.displayTotalPriceAndQuantity(productList.totalPrice(),
