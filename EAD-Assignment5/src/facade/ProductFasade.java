...
public class ProductFasade
{
     ...
     *            if same product added again then update old one else add a new
     *            product in the bucket
     */
    public void addInCart(int productID, int productQuantity)
    {
        ...
        while (itrator.hasNext())
        {
            ...
            {
                itreatorIndex.setProductQuantity(itreatorIndex
        ...
        if (flag)
        {
            productList.getUserBucket().add(
                    new UserBucket(productID - 1,
                            getNameOfProduct(productID - 1),
                            getPriceOfProduct(productID - 1) * productQuantity,
                            productQuantity));
        }
    }
